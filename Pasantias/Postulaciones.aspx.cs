    ...
    public partial class Postulaciones : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                // Llenar el DropDownList de departamentos
                CargarDepartamentos();
        ...
        protected void btnFiltrar_Click(object sender, EventArgs e)
        {
            if (Postulacion == null)
            {
                Postulacion = new Postulacion(); // Inicializar si es nulo
            }
            // Condición base de la vista
            string condicionBase = "u.RHConfirmado = 0"; // Cambiar según la vista (RH, Seguridad, Regional)
